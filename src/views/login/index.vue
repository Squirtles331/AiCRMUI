            ...
            <div class="login__content">
              <header class="login__mobile-brand">
                <div class="login__mobile-logo">
                  <img src="@/assets/images/logo.gif" alt="智能 CRM" />
                </div>
                <div>
                  <h2 class="login__mobile-title">智能 CRM</h2>
                  <p class="login__mobile-desc">销售业务管理平台</p>
                </div>
              </header>

              <h3 class="login__title">欢迎回来</h3>
              <p class="login__subtitle">请输入租户、账号和密码登录系统</p>
